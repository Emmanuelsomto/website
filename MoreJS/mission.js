...
const UpdatedCrew = swapCrewMembers(squad, 2, 5);
...
function sortProrityDescending(crew) {
...
function getEVAReadyCrew(crew) {
  ...
  sortProrityDescending(eligible);
  ...
  function chunkCrew(crew, size) {
   ...
   const chunkCrew = [];
     for (let i = 0; i < crew.length; i += chunkCrew.push(crew.slice(i, i + size)));
  }
